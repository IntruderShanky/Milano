...
public class RequestCreator {
    ...
    public void execute(OnRequestComplete onRequestComplete) {
        ...
        if (!NetworkConnection.isConnected(context))
            ...
            new ExecuteRequest(onRequestComplete).execute(configuration.getDefaultURLPrefix() + url);
        }
    }
    ...
    private class ExecuteRequest extends AsyncTask<String, String, String> {
        private final OnRequestComplete onRequestComplete;
        ProgressDialog dialog = new ProgressDialog(context);

        ExecuteRequest(OnRequestComplete onRequestComplete) {
